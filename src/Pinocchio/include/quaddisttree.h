...
{
public:
    static RootNode *make(const ObjectProjector<3, Tri3Object> &proj, const Pinocchio::Mesh &m, double tol)
    {
...
private:
    ...
    {
    public:
        DistObjEval(const ObjectProjector<3, Tri3Object> &inProj, const Pinocchio::Mesh &m) : proj(inProj), mint(m, Vector3(1, 0, 0))
        {
            level = 0;
